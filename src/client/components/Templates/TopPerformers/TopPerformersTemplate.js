...
const TopPerformers = (props) => {
    const { data, data: { Event }, org, photo, tableColor, textColor } = props;

    return <div id="photo-area" className="top-performers" style={{ color: `${textColor} !important` }}>
        ...
        <PerformersStatsTable playersData={data.Stats?.slice(0, 10)} tableColor={tableColor} textColor={textColor} />
    </div>
}
