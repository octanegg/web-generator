...
const MatchTemplate = (props) => {
    const { data, data: { Match }, org, photo, tableColor, textColor } = props;

    return <div id="photo-area" className="match-stats" style={{ color: `${textColor} !important` }}>
        ...
        <TeamStatsTable team1={data.Team1} team2={data.Team2} teamSize={data.Team1.length} textColor={textColor} tableColor={tableColor} />
